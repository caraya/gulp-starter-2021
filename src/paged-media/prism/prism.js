/* PrismJS 1.19.0
https://prismjs.com/download.html#themes=prism-solarizedlight&languages=markup+css+clike+javascript+apacheconf+bash+bison+c+csharp+cpp+cmake+css-extras+dart+docker+ejs+git+glsl+go+graphql+groovy+handlebars+java+javadoc+javadoclike+jsdoc+js-extras+js-templates+json+jsonp+kotlin+latex+lisp+lua+makefile+markdown+markup-templating+nginx+opencl+perl+php+php-extras+processing+protobuf+puppet+python+r+jsx+ruby+rust+sass+scss+smalltalk+soy+sparql+toml+turtle+typescript+wasm+xquery */
